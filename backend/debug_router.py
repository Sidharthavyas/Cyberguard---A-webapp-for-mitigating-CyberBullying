...
async def get_config():
    ...
    return {
        ...
        "has_twitter_client_id": bool(os.getenv("TWITTER_CLIENT_ID")),
        "has_twitter_consumer_key": bool(os.getenv("TWITTER_CONSUMER_KEY")),
        "has_twitter_consumer_secret": bool(os.getenv("TWITTER_CONSUMER_SECRET")),
        "has_twitter_bearer_token": bool(os.getenv("TWITTER_BEARER_TOKEN")),
